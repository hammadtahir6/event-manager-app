...
// Base Price in USD
const BASE_PRICE_USD = 30;

// Helper to format currency
const formatCurrency = (amount: number) => {
    return Math.ceil(amount); // Round up to nearest whole number for cleaner pricing
};
...
export const COUNTRIES_CURRENCIES = [
  { 
    ...
    rate: 1, 
    flag: '🇺🇸', 
    fixedIndividual: BASE_PRICE_USD, 
    fixedBusiness: BASE_PRICE_USD 
  },
  { 
    ...
    rate: 0.79, 
    flag: '🇬🇧', 
    fixedIndividual: formatCurrency(BASE_PRICE_USD * 0.79), 
    fixedBusiness: formatCurrency(BASE_PRICE_USD * 0.79) 
  },
  { 
    country: 'Canada', 
    currency: 'CAD', 
    ...
    rate: 1.36, 
    flag: '🇨🇦', 
    fixedIndividual: formatCurrency(BASE_PRICE_USD * 1.36), 
    fixedBusiness: formatCurrency(BASE_PRICE_USD * 1.36) 
  },
  { 
    country: 'Australia', 
    currency: 'AUD', 
    ...
    rate: 1.52, 
    flag: '🇦🇺', 
    fixedIndividual: formatCurrency(BASE_PRICE_USD * 1.52), 
    fixedBusiness: formatCurrency(BASE_PRICE_USD * 1.52) 
  },
  { 
    ...
    rate: 0.92, 
    flag: '🇪🇺', 
    fixedIndividual: formatCurrency(BASE_PRICE_USD * 0.92), 
    fixedBusiness: formatCurrency(BASE_PRICE_USD * 0.92) 
  },
  { 
    country: 'Pakistan', 
    currency: 'PKR', 
    ...
    rate: 278.50, 
    flag: '🇵🇰', 
    fixedIndividual: formatCurrency(BASE_PRICE_USD * 278.50), // Approx 8355
    fixedBusiness: formatCurrency(BASE_PRICE_USD * 278.50) 
  },
  { 
    country: 'India', 
    currency: 'INR', 
    ...
    rate: 83.50, 
    flag: '🇮🇳', 
    fixedIndividual: formatCurrency(BASE_PRICE_USD * 83.50), 
    fixedBusiness: formatCurrency(BASE_PRICE_USD * 83.50) 
  },
  { 
    ...
    rate: 3.67, 
    flag: '🇦🇪', 
    fixedIndividual: formatCurrency(BASE_PRICE_USD * 3.67), 
    fixedBusiness: formatCurrency(BASE_PRICE_USD * 3.67) 
  },
  { 
    ...
    rate: 3.75, 
    flag: '🇸🇦', 
    fixedIndividual: formatCurrency(BASE_PRICE_USD * 3.75), 
    fixedBusiness: formatCurrency(BASE_PRICE_USD * 3.75) 
  },
  { 
    country: 'China', 
    currency: 'CNY', 
    ...
    rate: 7.23, 
    flag: '🇨🇳', 
    fixedIndividual: formatCurrency(BASE_PRICE_USD * 7.23), 
    fixedBusiness: formatCurrency(BASE_PRICE_USD * 7.23) 
  },
  { 
    country: 'Japan', 
    currency: 'JPY', 
    ...
    rate: 151.50, 
    flag: '🇯🇵', 
    fixedIndividual: formatCurrency(BASE_PRICE_USD * 151.50), 
    fixedBusiness: formatCurrency(BASE_PRICE_USD * 151.50) 
  },
];
